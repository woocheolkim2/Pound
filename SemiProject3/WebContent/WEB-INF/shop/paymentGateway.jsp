...
$(document).ready(function() {
   ...
   IMP.request_pay({
       ...
       name : '${name}',	 // 코인충전 또는 order 테이블에 들어갈 주문명 혹은 주문 번호. (선택항목)원활한 결제정보 확인을 위해 입력 권장(PG사 마다 차이가 있지만) 16자 이내로 작성하기를 권장
       ...
       buyer_tel : '${loginMember.hp1+loginMember.hp2+loginMember.hp3}',    // 구매자 전화번호 (필수항목)
       buyer_addr : '',  
       buyer_postcode : '',
