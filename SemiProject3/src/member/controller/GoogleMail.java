...
public class GoogleMail {
    ...
    public void sendmail(String recipient, String certificationCode)  
    	...
    	// 제목 설정
    	String subject = "[Pound] 회원님의 비밀번호를 찾기위한 인증코드입니다.";
    ...
    public void sendmail_OrderFinish(String recipient, String name, String emailContents)  throws Exception{
    	...
    	// 제목 설정
    	String subject = "192.168.50.25:9090/MyMVC/mallHome.do "+name+"님의 주문이 성공했습니다. ";
    	msg.setSubject(subject);
    	...
    	// 메시지 본문의 내용과 형식, 캐릭터 셋 설정
    	msg.setContent(emailContents+"<h4>"+name+"님의 주문이 완료되었습니다.</h4><br/>"
    			+ "<a href='http://192.168.50.25:9090/SemiProject/home.do'>홈페이지 바로가기</a>", "text/html;charset=UTF-8");
